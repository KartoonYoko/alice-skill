...
import (
	...
	"github.com/KartoonYoko/alice-skill/internal/logger"
	"github.com/KartoonYoko/alice-skill/internal/models"
	"github.com/KartoonYoko/alice-skill/internal/store"
	"go.uber.org/zap"
)
...
func parseSendCommand(str string) (string, string) {
	return "", ""
}

func parseReadCommand(str string) int {
	return -1
}

func parseRegisterCommand(str string) string {
	return ""
}
